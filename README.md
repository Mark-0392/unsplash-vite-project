...
- search functionality (hint : search photos)
  path that we are going to use : https://api.unsplash.com/search/photos?client_id=YOUR_ACCESS_KEY &query=office; https://api.unsplash.com/search/photos?client_id=w2Rzc6M4I1M2ecWDLugHNJQw8h82PlRD2N-9eWaCu6M&query=office
  authorization key from the API: w2Rzc6M4I1M2ecWDLugHNJQw8h82PlRD2N-9eWaCu6M
